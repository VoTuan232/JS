...
var ChainBranchPoint = function (blockModelMap, id) {
    ...
    this.mode = DIVIDER_MODE_ENUM.dual;
...
ChainBranchPoint.prototype.getLinesSpecial = function () {
    return [
        new ChainBranchPointLine(this.blockModelMap, this.id, 1, this.x, this.y - 96 / 48 * BLOCK_WIDTH, this.A_CORNER, BRANCH_POINT_LINE_TYPE.aBranch),
        new ChainBranchPointLine(this.blockModelMap, this.id, 1, this.x, this.y - 72 / 48 * BLOCK_WIDTH, this.VERTICAL_LINE, BRANCH_POINT_LINE_TYPE.aBranch),
        new ChainBranchPointLine(this.blockModelMap, this.id, 1, this.x, this.y - 48 / 48 * BLOCK_WIDTH, this.VERTICAL_LINE, BRANCH_POINT_LINE_TYPE.aBranch),
    ];
};
