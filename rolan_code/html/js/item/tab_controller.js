...
$(function() {
	...
	$(document).on('elf-update', '.elf-tab-control', function(e, v) {
		var _$ = $(this);
	...
	$(document).on(pointer.down, '.elf-tab-item', function(e) {
		v_label = $(this);
	});

	$(document).on(pointer.down, '.elf-tab-control', function(e) {
		e.stopPropagation();
	...
	$(document).on(pointer.click, '.elf-tab-left-control', function(e) {
		e.stopPropagation();
		e.preventDefault();
		slide($(this).parent(),  1, 0, false);
	});

	$(document).on(pointer.click, '.elf-tab-right-control', function(e) {
		e.stopPropagation();
		e.preventDefault();
		slide($(this).parent(), -1, 0, false);
	});
