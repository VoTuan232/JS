...
(function () {
    window.librarianFormatRev = '0000'; // DataFormatRevision
    ...
    window.librarianCommonInfo = {
        ...
        librariansBass: [], // LibrarianBassObjects
        settingMode: 0, // LibrarianObjectのindex
        maxLivesetNum: 30, // LiveSetの上限
        maxPatchNum: 300, // Patchの上限
