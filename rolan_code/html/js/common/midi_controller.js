...
/* for MIDI debug
function dbglog(msg) {  console.log.apply( console, arguments );   }

LOG_MIDI_IN  = function(msg) { dbglog('in : ' + msg); };
LOG_MIDI_OUT = function(msg) { dbglog('out: ' + msg); };
*/


LOG_MIDI_IN  = function(msg) {
	console.log('LOG_MIDI_IN ' + msg);
};
LOG_MIDI_OUT = function(msg) {
	console.log('LOG_MIDI_OUT ' + msg);
};
