...
#define kRWCBytesPerFrame			(sizeof(SHORT) * 2) /* 16Bit-Stereo */
...
extern TCHAR* const RWCDeviceAddressKey;
extern TCHAR* const RWCDevicePortNoKey;
extern TCHAR* const RWCDeviceUIDKey;
extern TCHAR* const RWCDeviceCapsKey;
extern TCHAR* const RWCDeviceImageKey;
extern TCHAR* const RWCDeviceStatusKey;
extern TCHAR* const RWCDeviceManufacturerKey;
extern TCHAR* const RWCDeviceVersionKey;
extern TCHAR* const RWCDeviceNameKey;
